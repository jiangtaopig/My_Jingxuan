...
public class JingxuanProgramProgressView extends FrameLayout {
	private static final String TAG = "JingxuanProgramProgressView";
	private static final int MSG_UPDATE_PROGRESS = 0x3339;
	private ProgressBar mProgramProgress = null;
	private JingxuanProgramProgressListener mProgramProgressListener = null;
	...
	public JingxuanProgramProgressView(Context context) {
		super(context);
		init(context);
	}

	public JingxuanProgramProgressView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init(context);
	}

	public JingxuanProgramProgressView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initViews(Context context) {
		LayoutInflater.from(context).inflate(R.layout.jx_jingxuan_iotv_program_progress_view,
				this);
	...
	public void setProgressListener(JingxuanProgramProgressListener programProgressListener){
...
interface JingxuanProgramProgressListener {
	/**
	 * 进度条结束
	 */
