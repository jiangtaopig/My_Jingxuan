...
public class JingxuanChannelIndex extends FrameLayout {
	private static final String TAG = "JingxuanChannelIndex";
	...
	public JingxuanChannelIndex(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initViews(context);
	}

	public JingxuanChannelIndex(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initViews(context);
	}

	public JingxuanChannelIndex(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initViews(Context context) {
		...
		LayoutInflater.from(context).inflate(R.layout.jx_jingxuan_iotv_channel_index, this);
...
//		setNum(num2, mChannelNum2);
	...
	//add shensong
	public TextView getChannnelNameTView(){
		return mChannelName;
	}
