...
public class JXScheduleInvoker extends AbstractInvoker<BesTVHttpResult> {
	public JXScheduleInvoker(Object d) {
		super(d);
	}
	...
	public String getUrl() {
		return DataConfig.getJXScheduleUrl();
	}
	...
	public List<NameValuePair> getParams() {
		...
		String category = (String) req.getExtraData();
		params.add(new BasicNameValuePair("CategoryCode", category));
		return params;
	}
}
